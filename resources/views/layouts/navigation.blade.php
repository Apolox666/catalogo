<aside class="z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0">
    <div class="py-4 text-gray-500">
        ...
        <ul class="flex  flex-col gap-4 mt-6">
            <li class="relative px-6 py-3  rounded-lg">
                <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                    <x-slot name="icon">
                        <svg class="w-5 h-5 text-blue-700" aria-hidden="true" fill="none" stroke-linecap="round"
            ...
            <li class="relative px-6 py-3">
                <button
                    ...
                    <span class="inline-flex items-center ">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5" viewBox="0 0 640 512">
                        ...
                        <span class="ml-4">Grupos de trabajo</span>
                    </span>
                ...
                <template x-if="isMultiLevelMenuOpen">
                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                        ...
                        aria-label="submenu">
                        <li
                            class="px-2 py-1 transition-colors duration-150 hover:text-blue-500 dark:hover:text-gray-200">
                            <a class="w-full" href="{{ route('group.index') }}"> Administracion grupos de trabajo</a>
                        </li>
                    </ul>
                ...
                <template x-if="isMultiLevelMenuOpen">
                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                        ...
                        <li
                            ...
                            <a class="w-full" href="{{ route('responsible.index') }}">Registro de responsables</a>
                        </li>
                    </ul>
            ...
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('subprocess.index') }}" :active="request()->routeIs('subprocess.index')">
                    <x-slot name="icon">

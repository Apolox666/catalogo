                                ...
                                <td>
                                    <div class="flex gap-4 text-white items-center">
                                        <a href="{{ route('responsible.edit', $responsible->id) }}"
                                            class="px-4 p-2 bg-blue-500 items-center flex gap-2 rounded-md hover:bg-blue-400">
                                        ...
                                        <button
                                            class="px-4 p-2 bg-red-500 flex items-center gap-2 rounded-md hover:bg-red-400 eliminar"
